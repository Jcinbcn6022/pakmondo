...
const TRANSLATIONS = {
  ...
  es: {
    ...
    "onboard.welcomeBody": "Configuremos tu primer artículo juntos, agrupémoslo en un kit y creemos una lista para un viaje. Terminarás con una configuración inicial funcional. Tómate tu tiempo — puedes saltar en cualquier momento.",
